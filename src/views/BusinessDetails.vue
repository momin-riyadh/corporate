...
<script lang="ts">
    ...
    import CommonBusiness from '@/components/CommonBusiness.vue';

    @Component({
        name: 'BusinessDetails',
        components: {CommonParagraph, Copyright, Footer, CommonBanner, Navigation, BottomBanner, CommonBusiness},
    })
