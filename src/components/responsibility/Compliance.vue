<template>
  <div class="employees-welfare-area">
    <Navigation/>
    <CommonBanner v-bind:image-url="require('../../assets/images/compliance-top@2x.jpg')"
                  banner-title="Compliance" banner-subtitle="Employee welfare entails everything from services, facilities and benefits that are provided or done by an employer
 for the advantage or comfort of an employee. It is undertaken in order to"/>


    <CommonParagraph v-bind:ParagraphImage="require('../../assets/images/compliance-mid@2x.jpg')"
    ...
    <BottomBanner v-bind:BottomImage="require('../../assets/images/wwr@2x.jpg')" BottomTitle="Enhance society and the
...
<script lang="ts">
    ...
    @Component({
        name: 'EmployeesWelfare',
        components: {Navigation, CommonBanner, Footer, Copyright, BottomBanner, CommonParagraph},
    })
    export default class EnvironmentalResponsibility extends Vue {
